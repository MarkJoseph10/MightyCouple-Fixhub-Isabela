  ...
  return (
    <>
      <TiltCard className="h-full">
        ...
        >
          <div className={`relative flex items-center justify-center overflow-hidden bg-slate-950/30 ${compact ? "h-[158px] sm:h-[170px]" : "h-[188px] sm:h-[200px]"}`}>
            <img
          ...
          <div className={`flex flex-1 flex-col ${compact ? "gap-2 p-3" : "gap-3 p-3.5"}`}>
            <div className={`flex flex-col ${compact ? "gap-1.5" : "gap-4"} sm:flex-row sm:items-start sm:justify-between`}>
              <div className="min-w-0 flex-1">
                <h3
                  className={`break-words font-semibold leading-snug text-white ${compact ? "min-h-[2.4rem] text-[0.95rem]" : "min-h-[2.6rem] text-[1rem]"}`}
              ...
              <div className={`flex shrink-0 flex-col items-start text-left sm:items-end sm:text-right ${compact ? "mt-0.5" : ""}`}>
